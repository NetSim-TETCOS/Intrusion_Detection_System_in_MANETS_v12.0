...
static double fn_NetSim_IEEE802_11_CalculateBER(PIEEE802_11_PHY_VAR phy,double dReceivedPower)
{
	double snr = calculate_snr(dReceivedPower, phy->dChannelBandwidth);
	switch (phy->PhyType)
	{
		case DSSS:
			return Calculate_ber_by_calculation(snr, phy->PHY_TYPE.dsssPhy.modulation, phy->PHY_TYPE.dsssPhy.dDataRate, phy->dChannelBandwidth);
			break;
		case OFDM:
			return Calculate_ber_by_calculation(snr, phy->PHY_TYPE.ofdmPhy.modulation, phy->PHY_TYPE.ofdmPhy.dDataRate, phy->dChannelBandwidth);
			break;
		case HT:
			return Calculate_ber_by_calculation(snr, phy->PHY_TYPE.ofdmPhy_11n.modulation, phy->PHY_TYPE.ofdmPhy_11n.dDataRate, phy->dChannelBandwidth);
			break;
		case VHT:
			return Calculate_ber_by_calculation(snr, phy->PHY_TYPE.ofdmPhy_11ac.modulation, phy->PHY_TYPE.ofdmPhy_11ac.dDataRate, phy->dChannelBandwidth);
			break;
		default:
